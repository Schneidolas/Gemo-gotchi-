...
function buildFullDatabase() {
    ...
    const affectionTiers = ['PSYCHOPATH', 'HATE', 'ENMITY', 'UNKNOWN', 'ACQUAINTANCE', 'FRIEND', 'BEST_FRIEND', 'GIRLFRIEND', 'WIFE'];
...
export const FALLBACK_DIALOGUES_BY_ID = buildFullDatabase();